...
[red] VERSI: New
[red] CODE BY: KOREK_XD
[white] SCRIF : PREMIUM
[white] CRACK SAMBIL NGOPI
...
def auto():
	...
	wa.print(f'\r[green]Turn On / Off Flight ( mode pesawat ) Mode Before Use')
	print(f'{x}-------------------------------------------------------')
